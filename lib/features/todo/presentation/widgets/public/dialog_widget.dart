...
typedef OnEditPressed = void Function(TodoEnti todo);

class DialogMoreWidget extends StatelessWidget {
  const DialogMoreWidget({
    super.key,
  ...
  final OnEditPressed? onEditPressed;
      ...
      child: SizedBox(
        child: Container(
          ...
          child: Column(
            ...
            children: [
              PartTopOfDialog(todoEnti: todoEnti),
              PartDownOfDialog(
                todoEnti: todoEnti,
            ...
            child: SizedBox(
              ...
              child: ElevatedButton.icon(
                onPressed: () {
                  ...
                  onEditPressed!(todoEnti);
                },
                style: ElevatedButton.styleFrom(
                  backgroundColor: AppColors.bgGrandentTop,
